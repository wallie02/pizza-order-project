            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <div class="bg-light p-4 mb-30">
                        <form>
                            <div class=" bg-dark text-white px-3 py-1 d-flex align-items-center justify-content-between mb-3">
                                ...
                                <span class="badge border font-weight-normal">{{ count($categoryuser) }}</span>
                            </div>
                            ...
                            @foreach ( $categoryuser as $c )
                                <div class="  d-flex align-items-center justify-content-between mb-3 pt-1">
                                    <a href="{{route('user#userFilter',$c->id)}}" class="text-dark"><label class="" for="price-1">{{ $c->name }}</label></a>
                                </div>
                            @endforeach
                        </form>
                    </div>
                    ...
                    <a href="{{ route('user#contactPage')}}">
                        <button class="btn btn bg-primary text-white w-100">Contact Us</button>
                    </a>
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="row pb-3">
                        <div class="col-12 pb-1">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div>
                                    ...
                                    <a href="{{route('user#userHistory')}}" class="ms-3">
                                        <button type="button" class="btn btn-dark text-white position-relative">
                        ...
                        <span class="row" id="mydataList">
                            @if ( count($pizzauser) != 0)
                                @foreach ( $pizzauser as $p )
                                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1 shadow-sm mb-4 " style="height: 390px" >
                                        <div class="product-item bg-light mb-4" id='mysorting'>
                                            <div class="product-img position-relative overflow-hidden">
                                                <img class="img-fluid w-100 " style="height: 280px" src="{{asset('storage/'.$p->image)}}" alt="">
                                                <div class="product-action">
                                                    <a class="btn btn-outline-dark btn-square" href="#"><i class="fa fa-shopping-cart"></i></a>
                                                    <a class="btn btn-outline-dark btn-square" href="{{ route('user#pizzaDetials',$p->id)}}"><i class="fa-solid fa-info"></i></a>
                                                </div>
                                            </div>
                                ...
                                @endforeach
                            @else
                            <p class="text-dark fs-1 text-center col-6 offset-3 py-5">There is no PIZZA<i class="fa-solid fa-pizza-slice ms-2"></i></p>
                            @endif
                        </span>
            ...
            if($eventOption == 'asc'){
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        for($i=0; $i<response.length; $i++){
                            $list += `
                                <div class="col-lg-4 col-md-6 col-sm-6 pb-1" style="height: 350px" >
                                    <div class="product-item bg-light mb-4" id='mysorting'>
                                        <div class="product-img position-relative overflow-hidden">
